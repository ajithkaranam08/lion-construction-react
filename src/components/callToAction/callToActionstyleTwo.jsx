            ...
            <Col xs={12}>
              <div className="call-to-action-inner call-to-action-inner-4 text-center">
                <div className="section-title-area ltn__section-title-2">
                  <h6 className="section-subtitle ltn__primary-color">{` Looking for a Reliable Construction Partner?`}</h6>
                  <div className="text-white">
                    We bring your vision to life with precision, quality, and
                    commitment.
                  </div>
                  <h1 className="section-title white-color">+91 9840361427</h1>
                </div>
